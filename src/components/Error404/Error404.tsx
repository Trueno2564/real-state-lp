...
export function Error404() {
    return (
        <div className="flex flex-col items-center justify-center min-h-screen text-center px-5">
            ...
            <Image src='/assets/404-not-found.jpg' alt="404" width={600} height={450} className="rounded-lg shadow-light"/>
            <div className="text-center mt-5">
                <Link href='/' className="px-3 py-2 bg-secondary text-white rounded-lg">Volver al inicio</Link>
            </div>
        </div>
    )
}
